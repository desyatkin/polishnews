...
cConfigSm::instance('global_template3', '<div class="b-sotmarket-banner mod_blue" style="width: 314px;"><div class="b-sotmarket-banner-head"></div><div class="b-sotmarket-banner-content">
...
cConfigSm::instance('global_session_id', '/redir/,/redirects/,/cp/,/pages/informer/,/pages/footer/,/printpage/,/rss.php,/service/poisk/,/cgi-bin/');
